...
public class SecurityConfig {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        // /review/images/로 시작하는 요청을 classpath:/static/images/로 매핑
	...
	WebSecurityCustomizer webSecurityCustomizer() {
		return (webSecurity) -> webSecurity.ignoring().requestMatchers("/resources/**","/static/**", "/review/images/**","/images/**","/ignore2");
	}
